-- Migration: Fix interests column type from TEXT[] to JSONB
-- Date: 2025-07-13
-- Description: Convert interests column from PostgreSQL array to JSONB to match SQLAlchemy model
...
-- Step 6: Add constraint to ensure it's always a JSON array
